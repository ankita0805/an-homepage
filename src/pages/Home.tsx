...
Currently, I am a Senior Staff ML Researcher and Technical Lead at <strong>Qualcomm AI Research</strong>, guiding research in on device generative AI. I received my PhD in Electrical Engineering from <strong>Stanford University</strong>, where I continue to serve as Teaching Staff for the Machine Learning on Embedded Systems course. My goal is to bridge the gap between large scale AI models and practical, low-power systems.
      ...
      <section className="bg-muted/30 py-16">
        <div className="container mx-auto max-w-6xl px-6">
          ...
          <div className="space-y-4 text-foreground text-justify">
            <p>
            ...
            <p>
              Currently, I am a Principal ML Researcher (Director) at <strong>Qualcomm AI Research</strong>, where I lead research on efficient foundation model adaptation and on-device deployment. This role builds on my deep background in systems architecture. Previously, I led a cross-functional systems and architecture team at Qualcomm Wireless R&D that spearheaded ML initiatives for the world's first AI-enhanced 5G modem. Prior to focusing on AI, I was a <strong>Technical Lead for Qualcomm's 5G modem</strong>, where I led the architecture and design of first-generation 5G transmitter subsystems. My earlier industry experience at <strong>Qualcomm</strong> and <strong>Intel</strong> was centered on power-performance-area (PPA) optimization and low-power ASIC design methodologies, giving me a full-stack perspective from transistors up to algorithms.
            </p>
            <p>
