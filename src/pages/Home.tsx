      ...
      <section className="bg-muted/30 py-16">
        <div className="container mx-auto max-w-6xl px-6">
          ...
          <div className="space-y-4 text-foreground">
            ...
            <p>
              Currently, I am a Senior Staff ML Researcher at <strong>Qualcomm AI Research</strong>, where I lead research on efficient foundation model adaptation and on-device deployment. This role builds on my deep background in systems architecture. From 2020 to 2024, I served as <strong>Technical Lead/Senior Staff ML Engineer at Qualcomm Wireless R&D</strong>, where I led the <strong>on-device machine learning system architecture for 5G NR</strong>. In this role, I defined ML requirements for Qualcomm's 5G AI hardware roadmap, enabling AI-enhanced features within the 5G modem. I drove deep learning model quantization with hardware-aware inference, spearheaded performance-cost trade-offs for low-complexity fine-tuning algorithms for on-device learning, and led algorithm-hardware co-design to optimize ML workload mapping on the 5G AI processor. My earlier industry experience at <strong>Qualcomm</strong> and <strong>Intel</strong> was centered on power-performance-area (PPA) optimization and low-power ASIC design methodologies, giving me a full-stack perspective from transistors up to algorithms.
            </p>
            <p>
